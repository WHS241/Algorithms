...
public:
    ...
    // Check a specific group of sets to clear
    // Depending on usage, may be more efficient than calling clean() with no parameters
    void clean(const std::unordered_set<set_ptr, util::it_hash<set_ptr>>&);
