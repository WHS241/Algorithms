...
public:
    ...
    virtual EdgeWeight edge_cost(const uint32_t& start, const uint32_t& dest) const = 0;
    ...
    virtual std::list<std::pair<uint32_t, EdgeWeight>> edges(const uint32_t&) const = 0;
