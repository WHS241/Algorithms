...
RandomIt binarySearch(RandomIt first, RandomIt last, const T& item, Compare comp = Compare());
...
*/
template <typename RandomIt> uint32_t specialIndex(RandomIt first, RandomIt last);
} // namespace Sequence
